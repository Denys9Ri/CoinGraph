...
namespace CoinGecko.Clients
{
    public class BaseApiClient : IAsyncApiRepository
    {
        ...
        public Task<List<CoinMarkets>> GetCoinMarkets(string vsCurrency, string[] ids, string order, int? perPage, int? page, bool sparkline, string priceChangePercentage)
        {
